...
import SocialLoginButton from "@/pages/Login/components/SocialLoginButton.tsx";
import BiggerSocialLoginButton from "@/pages/Login/components/BiggerSocialLoginButton.tsx";
