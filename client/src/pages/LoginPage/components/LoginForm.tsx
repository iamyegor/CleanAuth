import SeparatorLine from "@/pages/LoginPage/components/SeparatorLine.tsx";
import InputField from "@/components/ui/InputField.tsx";
import RecoveryAndSignupLinks from "@/pages/LoginPage/components/RecoveryAndSignupLinks.tsx";
import SocialLoginButtons from "@/pages/LoginPage/components/SocialLoginButtons.tsx";
import { Form, redirect, useActionData, useNavigation } from "react-router-dom";
import api from "@/lib/api.ts";
import { AxiosError } from "axios";
import SubmittingButton from "@/components/ui/SubmittingButton.tsx";
import { validateCredentials } from "@/pages/LoginPage/utils/validateCredentials.ts";
import ServerErrorResponse from "@/types/ServerErrorResponse.ts";
import LoginError from "@/pages/LoginPage/types/LoginError.ts";
import { Result } from "@/utils/resultOfT.ts";
import { parseResponseToLoginError } from "@/pages/LoginPage/utils/parseResponseToLoginError.ts";
